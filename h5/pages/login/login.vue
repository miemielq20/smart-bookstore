<template>
  <view class="screen">
    ...
    <view class="field">
      <text>密码</text>
      <view class="field-box">
        <u-input v-model="form.password" type="password" placeholder="输入登录密码" border="none" clearable />
      </view>
    </view>
    ...
    <u-button class="primary-action" color="#24433B" :loading="submitting" text="登录" @click="submit" />
...
<script lang="ts" setup>
  ...
  function showSmsTip() { uni.showToast({ title: '短信验证码登录即将开放', icon: 'none' }) }
...
<style lang="scss" scoped>
  ...
  .login-mark {
    ...
    background: #606c38;
    box-shadow: inset -14px 0 rgba(255, 253, 247, 0.18), 0 18px 36px rgba(44, 36, 22, 0.16);
  }
