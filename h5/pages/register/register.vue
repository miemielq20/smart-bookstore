<template>
  <view class="screen">
    ...
    />
    <view class="page-topbar" @tap="goBack"
      ><view class="back-action"><u-icon name="arrow-left" color="#FFFDF7" size="18" /></view
      ><text>返回上一级</text></view
    >
      ...
      ><view class="captcha-row"
        ...
        ><view class="captcha-img" @tap="refreshCaptcha"
          ><image
            ...
            :src="captcha.img"
            mode="aspectFill"
          /><text v-else class="captcha-placeholder">点击获取验证码</text></view
        ></view
      ></view
    >
    <u-button
    ...
    <view class="login-row"
      ><text>已有账号？</text><text class="login-link" @tap="goBack">返回登录</text></view
    >
  </view>
</template>
