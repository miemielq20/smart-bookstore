      ...
      <div class="right-panel">
        ...
        <el-form ref="formRef" :model="form" :rules="rules" @keyup.enter="handleLogin">
          <el-form-item prop="username">
            <el-input v-model="form.username" placeholder="管理员账号 / 手机号" :prefix-icon="User" size="large" />
          </el-form-item>
          ...
          <el-form-item prop="captcha">
            <div class="captcha-row">
              <el-input v-model="form.captcha" placeholder="验证码" :prefix-icon="Key" size="large" />
  ...
  .login-page {
    ...
    .left-panel {
      ...
      &::after {
        ...
        position: absolute;
        inset: 0;
        background: radial-gradient(ellipse at 30% 80%, rgba(255, 255, 255, 0.04) 0%, transparent 60%);
        pointer-events: none;
      }
    }
