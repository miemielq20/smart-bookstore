...
export class AddressController {
  ...
  @Post() create(@Req() req: Request, @Body() dto: AddressDto) {
  ...
  @Post(':id/default') setDefault(@Req() req: Request, @Param('id', ParseIntPipe) id: number) {
    return this.service.setDefault(this.userId(req), id)
  }
